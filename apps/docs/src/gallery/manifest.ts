...
export const GALLERY: GallerySection[] = [
  ...
  },
  {
    ...
    components: ['Text', 'Heading', 'Link', 'Blockquote', 'Code', 'CodeBlock', 'Markdown', 'Citation', 'Outline'],
  },
  {
    slug: 'media',
...
export const OMITTED: { name: string; reason: string }[] = [
  ...
  {
    name: 'FieldLabel',
    reason: "Low-level sub-part Field renders internally from its own `label` prop; not composed separately by consumers.",
  },
  {
    name: 'FieldStatus',
    reason: "Low-level sub-part Field renders internally from its own `status` prop; not composed separately by consumers.",
  },
  { name: 'InputGroupText', reason: 'Sub-part of InputGroup; composed within its example.' },
  { name: 'SegmentedControlItem', reason: 'Sub-part of SegmentedControl; composed within its example.' },
  {
    name: 'InputClearButton',
    reason: 'Internal input-decoration primitive (the clear button inside TextInput/Typeahead); not used standalone.',
  },

  // --- Data Display sub-parts ---
  { name: 'ListItem', reason: 'Sub-part of List; composed within its example.' },
  { name: 'TableCell', reason: "Sub-part of Table; Table's data+columns API renders these internally." },
  ...
  {
    name: 'TableBody',
    reason: 'Sub-part of Table (children-composition mode); Table is demoed via its data-driven mode instead.',
  },
  { name: 'TableFooter', reason: 'Sub-part of Table (children-composition mode); not needed for the data-driven demo.' },
  { name: 'TableHeader', reason: 'Sub-part of Table (children-composition mode); not needed for the data-driven demo.' },
  ...
  { name: 'DropdownMenuItem', reason: 'Sub-part of DropdownMenu; the items-array API renders these internally.' },
  { name: 'ContextMenuItem', reason: 'Sub-part of ContextMenu; the items-array API renders these internally.' },
  ...
  { name: 'BreadcrumbItem', reason: 'Sub-part of Breadcrumbs; composed within its example.' },
  {
    ...
    reason: 'Sub-part of SideNav (collapsible-mode trigger); the SideNav example here keeps to a simple item list and does not exercise collapsible mode.',
  },
  {
    name: 'SideNavHeading',
    reason: 'Sub-part of SideNav (heading slot within a section); the SideNav example here keeps to a simple item list.',
  },
  { name: 'SideNavItem', reason: 'Sub-part of SideNav; composed within its example (and the AppShell example).' },
  {
    name: 'SideNavSection',
    reason: 'Sub-part of SideNav (grouped-section slot); the SideNav example here keeps to a simple item list.',
  },
  { name: 'TopNavHeading', reason: 'Sub-part of TopNav; composed within its example (and the AppShell example).' },
  {
    name: 'TopNavItem',
    reason: 'Sub-part of TopNav (nav-link slot); the TopNav example here only exercises the heading slot.',
  },
  {
    name: 'TopNavMegaMenu',
    reason: 'Sub-part of TopNav; a full mega-menu composition is too heavy for a single gallery card.',
  },
  { name: 'TopNavMegaMenuFeaturedCard', reason: "Sub-part of TopNav's mega menu; see TopNavMegaMenu." },
  { name: 'TopNavMegaMenuItem', reason: "Sub-part of TopNav's mega menu; see TopNavMegaMenu." },
  {
    name: 'TopNavMenu',
    reason: 'Sub-part of TopNav (dropdown nav-item slot); the TopNav example here only exercises the heading slot.',
  },
  {
    name: 'NavIcon',
    reason: 'Thin icon-slot wrapper for nav items; not exercised by the TopNav/SideNav examples here, not independently meaningful on its own.',
  },
  ...
  { name: 'CommandPaletteEmpty', reason: 'Sub-part of CommandPalette (empty-results slot); rendered internally by default.' },
  { name: 'CommandPaletteFooter', reason: 'Sub-part of CommandPalette (default footer slot); rendered internally by default.' },
  { name: 'CommandPaletteGroup', reason: 'Sub-part of CommandPalette; used to group items within its example.' },
  { name: 'CommandPaletteInput', reason: 'Sub-part of CommandPalette (default input slot); rendered internally by default.' },
  { name: 'CommandPaletteItem', reason: 'Sub-part of CommandPalette; rendered internally from searchSource results.' },
  { name: 'CommandPaletteList', reason: 'Sub-part of CommandPalette; rendered internally.' },
  { name: 'NavHeadingMenu', reason: 'Internal nav-heading dropdown sub-part; no standalone usage documented.' },
  { name: 'NavHeadingMenuItem', reason: 'Internal nav-heading dropdown sub-part; no standalone usage documented.' },
  ...
  { name: 'GridSpan', reason: 'Sub-part of Grid (a grid-item span wrapper); no standalone meaning outside a Grid.' },
  {
    name: 'StackItem',
    reason: 'Sub-part of Stack; the Stack example here uses plain children instead (Stack’s own prop docs were incomplete, so the safest common-denominator API was used).',
  },
  ...
  {
    name: 'LayoutPanel',
    reason: 'Sub-part of Layout (side-panel slot); the Layout example here only exercises header/content/footer.',
  },

  // --- Media & Communication sub-parts ---
  { name: 'ChatComposerDrawer', reason: "Sub-part of ChatComposer's drawer slot; not independently meaningful." },
  {
    name: 'ChatComposerInput',
    reason: "Sub-part of ChatComposer's input slot; the ChatComposer example composes a plain input in that slot.",
  },
  { name: 'ChatDictationButton', reason: 'Niche action sub-part for a ChatComposer action slot; not exercised by the minimal ChatComposer example here.' },
  {
    name: 'ChatLayout',
    reason:
  ...
  { name: 'ChatMessageMetadata', reason: 'Optional timestamp/status sub-part for ChatMessage; the minimal ChatMessage example here omits it.' },
  { name: 'ChatSendButton', reason: 'Optional send-button override for ChatComposer; the minimal ChatComposer example here uses the default.' },
  { name: 'ChatTokenizedText', reason: 'Sub-part for rendering tokenized/highlighted message text; niche to demo alone.' },
  { name: 'ChatToolCalls', reason: 'Sub-part for rendering tool-call traces inside a message; niche to demo alone.' },
  { name: 'ChatComposerTokenElement', reason: 'Internal token-rendering sub-part of ChatComposerInput.' },
  {
  ...
  { name: 'InternationalizationProvider', reason: 'Provider (excluded per instructions); configures locale context, renders nothing itself.' },
  { name: 'LinkProvider', reason: 'Provider (excluded per instructions); configures the link-rendering context, renders nothing itself.' },
  {
    name: 'MediaTheme',
    reason:
  ...
  {
    name: 'SyntaxTheme',
    reason: 'Syntax-highlighting theme/config object (CLI category "Utility"); not a visual component.',
  },
  {
    name: 'Item',
    reason:
  ...
  {
    name: 'VisuallyHidden',
    reason: 'Renders no visible output by design (a screen-reader-only text primitive) — a demo card would always appear empty.',
  },
];
