...
function ToastExample(): ReactElement {
  ...
  return <Button label="Show toast" variant="secondary" onClick={() => toast({ body: 'Changes saved.' })} />;
}
  ...
  return (
    <>
      ...
      <Lightbox
        isOpen={isOpen}
        onOpenChange={setIsOpen}
        media={{ src: PLACEHOLDER_IMG, alt: 'Abstract placeholder graphic', caption: 'A quiet placeholder graphic.' }}
      />
    </>
  );
}
...
function CommandPaletteExample(): ReactElement {
  ...
  return (
    <>
      ...
      <CommandPalette isOpen={isOpen} onOpenChange={setIsOpen} isInline searchSource={PEOPLE_SOURCE} />
    </>
  );
}
...
export const EXAMPLES: Record<string, () => ReactElement> = {
  ...
  ToggleButton: () => <ToggleButton label="Bold" value="bold" isPressed onPressedChange={() => {}} />,
  ToggleButtonGroup: () => (
  ...
  CheckboxInput: () => <CheckboxInput label="Email me about product updates" value onChange={() => {}} />,
  CheckboxList: () => (
  ...
  DateRangeInput: () => (
    <DateRangeInput label="Trip dates" value={{ start: '2026-08-03', end: '2026-08-10' }} onChange={() => {}} />
  ),
  ...
  Selector: () => (
    <Selector label="Status" value="Open" onChange={() => {}} options={['Open', 'In progress', 'Done']} />
  ),
  MultiSelector: () => (
    <MultiSelector
      label="Assignees"
  ...
  Typeahead: () => (
    <Typeahead label="Assignee" searchSource={PEOPLE_SOURCE} value={{ id: 'ada', label: 'Ada Lovelace' }} onChange={() => {}} />
  ),
  Tokenizer: () => (
    <Tokenizer label="Tags" searchSource={PEOPLE_SOURCE} value={[{ id: 'ada', label: 'Ada Lovelace' }]} onChange={() => {}} />
  ),
  InputGroup: () => (
  ...
  Field: () => (
    <Field label="Email address" inputID="email-input" description="Used only to send receipts." descriptionID="email-help">
      <input id="email-input" aria-describedby="email-help" placeholder="you@example.com" type="email" />
    </Field>
  ),
  SegmentedControl: () => (
  ...
  Thumbnail: () => <Thumbnail src={PLACEHOLDER_IMG} alt="Abstract placeholder graphic" label="cover.png" />,
  MetadataList: () => (
  ...
  HoverCard: () => (
    <HoverCard
      content={
        <Text type="body">Grace Hopper — Rear Admiral, USN. Pioneered machine-independent programming languages.</Text>
      }
    >
  ...
  ContextMenu: () => (
    <ContextMenu items={[{ label: 'Rename' }, { label: 'Duplicate' }, { type: 'divider' }, { label: 'Delete' }]}>
      <Card padding={6}>
        <Text type="body" color="secondary">
  ...
  Pagination: () => <Pagination page={1} onChange={() => {}} totalItems={100} pageSize={10} variant="pages" />,
  ...
  AppShell: () => (
    <div style={{ height: 260, overflow: 'hidden', border: '1px solid var(--color-border)', borderRadius: 12 }}>
      <AppShell
        variant="surface"
        contentPadding={4}
  ...
  Layout: () => (
    <div style={{ height: 220, overflow: 'hidden', border: '1px solid var(--color-border)', borderRadius: 12 }}>
      <Layout
        header={
          <LayoutHeader>
  ...
  ChatComposer: () => <ChatComposer value="" onChange={() => {}} onSubmit={() => {}} placeholder="Message the team..." />,
  ChatSystemMessage: () => <ChatSystemMessage>Ada Lovelace joined the conversation.</ChatSystemMessage>,
};
