...
const INVARIANTS = [
  ...
  ['Depth whispers', 'A ring for focus, one soft shadow for lift — hard drop shadows are forbidden.'],
...
export function Principles() {
  return (
    <article>
      ...
      <p className="fd-lede">
        Ten invariants inherited from the Kami visual language, and the four places MSW
        deliberately extends it for interactive UI.
      </p>
